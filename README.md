...
func main() {
	...
	fmt.Println(json.MarshalIndent(destData, "", "  "))
	// {
	// 	"info": {
	// 		"authors": ["Nietzsche", "Schopenhauer", "Stirner", "Camus", "Dostoevsky"],
	// 		"birthYears": [1844, 1788, 1806, 1913, 1821]
	// 	}
	// }
}
